...
const games = [
  { name: "Aaloo_Ka_Sona_AR", type: "AR Experience" },
  { name: "ImageTracking_AR", type: "AR Module" },
  { name: "BasketBall_AR", type: "AR Game" },
  { name: "ShapeShifter_AR", type: "AR Puzzle" },
  { name: "Turbine_AR", type: "AR Visualization" },
  { name: "Open_The_Lock", type: "Puzzle Game" },
  { name: "Road_Racer", type: "Racing Game" },
  { name: "HackMan", type: "Arcade Game" },
  { name: "Kill_The_Drago", type: "Action Game" },
  { name: "Block_Breaker_2d", type: "Classic Arcade" },
  { name: "Space_Hunters", type: "Space Shooter" },
  { name: "Spiral_Girl", type: "Platformer" },
]
        ...
        {games.map((game, index) => (
          ...
          >
            <Card className="h-full flex flex-col hover:border-primary/50 transition-colors bg-background/50 backdrop-blur-sm group overflow-hidden">
              <div className="h-32 bg-secondary/30 relative flex items-center justify-center border-b border-border overflow-hidden">
